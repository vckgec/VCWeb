...
urlpatterns = [
    ...
    url(r'^book/edit/(?P<pk>[0-9]+)/$',
        login_required(views.BookEdit.as_view()), name='edit'),
    ...
    url(r'^request/(?P<id>[0-9]+)/collect/$',
        views.CollectBook, name='collect'),
    url(r'^request/(?P<id>[0-9]+)/undoreturn/$',
        views.UndoReturn, name='undoreturn'),
